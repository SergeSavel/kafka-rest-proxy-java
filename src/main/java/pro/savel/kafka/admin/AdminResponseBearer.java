...
public class AdminResponseBearer extends ResponseBearer<AdminResponse> {

    public AdminResponseBearer(RequestBearer requestBearer, HttpResponseStatus status, AdminResponse response) {
